...
<div id="app">
    ...
    <div id="paso-1" class="seccion">
        <h2>Servicios</h2>
        <p class="text-center">¿Que servicios deseas?</p>
        <!-- este div se deja vacio y se inserta con js -->
    ...
    <div id="paso-2" class="seccion">
        ...
        <form class="formulario">
            ...
            <div class="campo">
                ...
                <!-- funcion de php que habilita las fechas a partir del dia siguiente al actual -->
